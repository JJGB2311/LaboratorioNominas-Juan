...
namespace LaboratorioNomina_Juan
{
    ...
    {
        OdbcConnection conn = new OdbcConnection("Dsn=Pra2");
        ...
        public Nomina(string user)
        {
            ...
            combo3.llenarse("concepto", "codigo_concepto");
        }
        void llenartbl()
        {
        ...
        void Insertar2()
        {
            ...
            conn.Close();
            string query = "INSERT INTO `nominad` (`codigo_nomina`, `codigo_empleado`, `codigo_concepto`, `estado`) VALUES ('"+txtcodigo.Text+"', '"+ combo1.obtener() + "', '"+ combo3.obtener() + "', '1');";
